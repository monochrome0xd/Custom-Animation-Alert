...
이 폴더가 `https://monochrome0xd.github.io/Custom-Animation-Alert/` 의 공개 사이트입니다.

## GitHub Pages 활성화 절차

1. GitHub에 push (`git add docs && git commit -m "docs: add privacy policy" && git push`)
2. https://github.com/monochrome0xd/Custom-Animation-Alert/settings/pages 접속
3. **Build and deployment** 섹션에서:
   - **Source**: `Deploy from a branch`
   - **Branch**: `main` (또는 `master`) 선택, 폴더는 **`/docs`** 선택
4. Save 클릭
5. 1-2분 후 다음 URL 활성화:
   - 홈: `https://monochrome0xd.github.io/Custom-Animation-Alert/`
   - 개인정보처리방침: `https://monochrome0xd.github.io/Custom-Animation-Alert/privacy-policy.html`
